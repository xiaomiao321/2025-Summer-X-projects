...
void McpServer::AddCommonTools() {
    ...
    AddTool("control_weather_clock",
        "Controls the separate weather clock device. Use 'show' to display the weather and 'hide' to hide it.",
        PropertyList({
            Property("command", kPropertyTypeString, false, "The command to send to the weather clock. Can be \"show\" or \"hide\".")
        }),
        [](const PropertyList& properties) -> ReturnValue {
            ...
            if (protocol) {
                ...
                protocol->Publish("cmnd/weather_clock/action", command);
